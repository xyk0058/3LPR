...
class Trainer(object):
    ...
    def get_train_features(self):
        ...
        if self.args.dataset == 'cifar10' or self.args.dataset == 'imblancecifar10':
            ...
            mean = [0.4914, 0.4822, 0.4465]
            std = [0.2023, 0.1994, 0.2010]
        elif self.args.dataset == 'ImbSmallImageNet127_x32' or self.args.dataset == 'ImbSmallImageNet127_x64':
        ...
        if self.args.dataset == 'miniimagenet':
            size = 84
        elif self.args.dataset == 'ImbSmallImageNet127_x64':
            size = 64
    ...
    def kNN(self, K=200, sigma=0.1):    
        ...
        if self.args.dataset == 'imblancestl10':
            trainLabels = torch.LongTensor(self.train_loader.dataset.labels).cuda()
        else:
...
def main():
    ...
    parser.add_argument("--net", type=str, default="wideresnet282",
                        ...
                        help="net name")
    parser.add_argument("--dataset", type=str, default="cifar10", choices=["cifar10", "cifar100", "miniimagenet", "imblancecifar10", "imblancecifar100", "imblancestl10", "ImbSmallImageNet127_x32", "ImbSmallImageNet127_x64"])
