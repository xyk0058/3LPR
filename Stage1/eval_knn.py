...
imb_fac = int(s.split('_')[1])
net = s.split('_')[2].lower()
...
elif net == "wide282" or net == "wideresnet282":
...
if dataset == 'cifar10' or dataset == "imbcifar10":
...
elif dataset == "imbcifar10":
    # trainset = datasets.imblancecifar10(transform=transform, regim='train', imb_factor=1./imb_fac)
    trainset = datasets.cifar10(transform=transform, regim='train')
    testset = datasets.cifar10(transform=transform, regim='val')
else:
    raise NotImplementedError
