...
def get_cifar10(root, l_samples, u_samples, transform_train=transform_train, transform_strong=transform_strong,
    ...
    # print('mmax', max(train_labeled_idxs), min(train_labeled_idxs))
    # print('mmax', max(train_unlabeled_idxs), min(train_unlabeled_idxs))
...
class CIFAR10_labeled(torchvision.datasets.CIFAR10):
    ...
    def __init__(self, root, indexs=None, train=True,
        ...
        print('CIFAR10_labeled', len(self.data))
