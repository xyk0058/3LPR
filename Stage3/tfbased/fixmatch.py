...
class FixMatch(CTAReMixMatch):
    ...
    def train(self, train_nimg, report_nimg):
        ...
        with tf.train.MonitoredTrainingSession(
            ...
            print('trange!!!!', self.tmp.step % report_nimg, report_nimg, batch)
...
def main(argv):
    utils.setup_main()
    del argv  # Unused.
    print('PAIR_DATASETS', data.PAIR_DATASETS().keys())
    # dataset = data.PAIR_DATASETS()[FLAGS.dataset]()
    dataset = data.DataSets.creator(FLAGS.dataset, nclass=10)[1]()
