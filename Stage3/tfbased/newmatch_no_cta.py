...
class NewMatch(MixMatch):
    ...
    def model(self, batch, lr, wd, beta, w_kl, w_match, w_rot, K, use_xe, warmup_kimg=1024, T=0.5,
        ...
        N_prob = tf.placeholder(tf.float32, [self.nclass], 'N_prob')
        ...
        return EasyDict(
            ...
            ly=ly, N=N, l_dbg=l_dbg, Z_unlabeled=Z_unlabeled, Z_labeled=Z_labeled, sample_epoch=sample_epoch,
            labeled_idx=labeled_idx, labeled_label=labeled_label, N_prob=N_prob)
